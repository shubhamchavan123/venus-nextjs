        ...
        <div className='grid md:grid-cols-12 items-center gap-7'>
          ...
          <div
            ...
            <h2 className='pt-9 pb-8 text-midnight_text font-bold dark:text-white text-4xl'>
              My Flutter Development Skills & Experience
            </h2>

            <p className='text-gray dark:text-white/70 text-base font-semibold'>
              I specialize in building high-quality mobile applications using Flutter.
              My work focuses on creating responsive UI, seamless API integrations,
              secure authentication, and scalable architectures for real-world apps.
            </p>
